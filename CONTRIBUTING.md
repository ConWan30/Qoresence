...
3. Update `docs/` and `docs/wiki/` if the feature is user-facing. Session Theater / CIVIF narrative changes go in `docs/SESSION_THEATER.md` and `docs/CIVIF.md`. Operator-bot routing goes in `docs/GROK_BOT_CORPS.md`.
