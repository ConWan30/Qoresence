...
class AgentGlass:
    ...
    def __init__(
        ...
        *,
        ...
        maxlen = (
            int(getattr(config, "max_history", _DEFAULT_MAXLEN) or _DEFAULT_MAXLEN)
            if config
            else _DEFAULT_MAXLEN
        )
    ...
    def health(self) -> dict[str, Any]:
        ...
        return {
            ...
            "seq": snap.get("seq", 0),
            "events_count": snap.get("events_count", 0),
            "video": snap.get("video", {}),
            "coupling": snap.get("coupling", {}),
            "bus_clients": snap.get("bus", {}).get("ws_clients", 0),
