...
Cloud path: Quicksilver vision (default gemini-3.8-flash).
    ...
    def __init__(
        ...
        if _prefer or not _has_deepseek:
            ...
            log.info(
                ...
                getattr(config, "model_name", "gemini-3.8-flash"),
            )
    ...
    def _maybe_mint_picture_hid(
        ...
        *,
        ...
        try:
            ...
            model = str(getattr(self.config, "model_name", "") or "gemini-3.8-flash")
