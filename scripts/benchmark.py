...
from qoresence.core import RetinaEventBus, SessionAuthority, SourceLobe, clock_ns
...
class BenchmarkRunner:
    ...
    def print_results(self):
        ...
        print("=" * 100)
        print(
            f"{'Test':<35} {'Iters':>8} {'Ops/s':>12} {'p50(ms)':>10} {'p95(ms)':>10} {'p99(ms)':>10} {'Max(ms)':>10} {'Peak(MB)':>10}"
        )
        print("-" * 100)
        for r in self.results:
            print(
                f"{r.name:<35} {r.iterations:>8} {r.ops_per_sec:>12.1f} {r.latency_p50_ms:>10.2f} {r.latency_p95_ms:>10.2f} {r.latency_p99_ms:>10.2f} {r.latency_max_ms:>10.2f} {r.memory_peak_mb:>10.1f}"
            )
        print("=" * 100)
...
async def benchmark_wasm_validation_real():
    ...
    if not wasm_path.exists():
        wasm_path = Path(
            "../vapi-pebble-prototype/w3bstream/applet/target/wasm32-unknown-unknown/release/w3bstream_applet.wasm"
        )
