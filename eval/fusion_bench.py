...
def bench(n=200):
    from qoresence.core import RetinaUnifiedConfig, clock_ns, SourceLobe, EventType, BaseEvent
    ...
    def run_synced():
        ...
        for i in range(10):
            ...
            bus.emit(BaseEvent(session_id="bench", clock_ns=ns, source_lobe=SourceLobe.CONTROLLER, type=EventType.TRIGGER_ONSET, payload={}))
            bus.emit(BaseEvent(session_id="bench", clock_ns=ns+30_000_000, source_lobe=SourceLobe.SCREEN, type=EventType.CV_MOTION, payload={"motion":0.8}))
        time.sleep(0.05)
