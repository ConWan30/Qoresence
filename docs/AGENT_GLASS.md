...
| `get_observation` | **Witness pack**: SEQGATE-licensed title/score/phrase/glass the agent *may* say; unlicensed digits are `□–□` / silent; stale memory cannot license live digits; localhost phone URLs stay silent | — |
