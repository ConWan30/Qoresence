...
test("studio/mobile use locked shell scrollport", () => {
...
test("session theater scrollport has min-h-0 inner tab scroll", () => {
  ...
  assert.match(src, /min-h-0 flex-1 overflow-y-auto overscroll-y-contain/);
});
